...
METRIC_COL = "loss/actor_loss"
METRIC_SLUG = "training_actor_loss"


def main():
    parser = argparse.ArgumentParser(description="Plot training actor loss per update")
    ...
    title = args.title or "Training Actor Loss"
