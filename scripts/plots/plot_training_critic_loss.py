...
METRIC_COL = "loss/critic_loss"
METRIC_SLUG = "training_critic_loss"


def main():
    parser = argparse.ArgumentParser(description="Plot training critic loss per update")
    ...
    title = args.title or "Training Critic Loss"
