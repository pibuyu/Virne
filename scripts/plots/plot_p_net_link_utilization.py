...
METRIC_COL = "p_net_link_resource_utilization"
METRIC_SLUG = "p_net_link_resource_utilization"


def main():
    parser = argparse.ArgumentParser(description="Plot physical link resource utilization over time")
    ...
    title = args.title or "P-Net Link Resource Utilization"
