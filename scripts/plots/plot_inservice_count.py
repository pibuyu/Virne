...
METRIC_COL = "inservice_count"
METRIC_SLUG = "inservice_count"


def main():
    parser = argparse.ArgumentParser(description="Plot in-service count over time")
    ...
    title = args.title or "In-service Count"
