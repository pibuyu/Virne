...
METRIC_COL = "loss/entropy_loss"
METRIC_SLUG = "training_entropy_loss"


def main():
    parser = argparse.ArgumentParser(description="Plot training entropy loss per update")
    ...
    title = args.title or "Training Entropy Loss"
