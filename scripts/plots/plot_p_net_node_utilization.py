...
METRIC_COL = "p_net_node_resource_utilization"
METRIC_SLUG = "p_net_node_resource_utilization"


def main():
    parser = argparse.ArgumentParser(description="Plot physical node resource utilization over time")
    ...
    title = args.title or "P-Net Node Resource Utilization"
